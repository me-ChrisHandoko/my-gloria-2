-- Remove module_change_history model
...
--   - old_values, new_values, changed_fields (same as module_change_history)
...
DROP TABLE IF EXISTS "gloria_ops"."module_change_history" CASCADE;
