...
export const metadata: Metadata = {
  ...
  description: 'Create your Gloria System account to start managing government workflows',
};
    ...
    <div className="w-full">
      <div className="mb-8 text-center">
        ...
        <p className="text-gray-600">
          Join Gloria System to streamline government workflows
        </p>
      </div>
      ...
      <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
        <p className="text-sm text-blue-800">
          <strong>Note:</strong> Your account will need to be approved by an administrator
          before you can access all features of Gloria System.
        </p>
      </div>
    </div>
  );
